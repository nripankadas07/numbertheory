...
`numbertheory`: Pure-Python number-theory helpers: gcd/lcm, extended Euclid, modular inverse, Miller-Rabin, factorisation, Euler phi, Mobius, CRT, Jacobi/Legendre. Zero dependencies..
